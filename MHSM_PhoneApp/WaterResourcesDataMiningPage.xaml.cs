...
{
    public partial class WaterResourcesDataMiningPage : PhoneApplicationPage
    {
        public WaterResourcesDataMiningPage()
        {
            InitializeComponent();
            avatarSmall.Source = new BitmapImage(new Uri(ConfigClass.UserData.user.Avatar));
            LoadStationWaterResourcesDataMining("","","");
        }

        private async void LoadStationWaterResourcesDataMining(string stationName, string sizeNo, string provinceNo)
        {
            var post = new
            {
        ...
        private void Search()
        {
            ...
            LoadStationWaterResourcesDataMining(txtStationName.Text, siteNo, provinceNo);
        }
        ...
        private void btnDetailStationWaterResourcesDataMining_Click(object sender, RoutedEventArgs e)
        {
            var tag = (sender as Button).Tag;
            NavigationService.Navigate(new Uri("/WaterResourcesDataMiningDetailPage.xaml?ST_ID=" + tag, UriKind.Relative));
        }
