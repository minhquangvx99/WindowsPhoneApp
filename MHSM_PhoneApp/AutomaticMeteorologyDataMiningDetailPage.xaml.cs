...
{
    public partial class AutomaticMeteorologyDataMiningDetailPage : PhoneApplicationPage
    {
        string ST_ID = string.Empty;
        public AutomaticMeteorologyDataMiningDetailPage()
        {
            InitializeComponent();
        ...
        private async void LoadStationAutomaticMeteorologyDataMiningDetail(string ST_ID, long fromDate, long toDate)
        {
            var post = new
            {
            ...
            {
                txtTitle3.Text = "Khí tượng tự động";
            }
            else
            {
        ...
        private void Search()
        {
            ...
            LoadStationAutomaticMeteorologyDataMiningDetail(ST_ID, from, to);
        }
