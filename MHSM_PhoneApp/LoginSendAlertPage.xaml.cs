...
{
    public partial class LoginSendAlertPage : PhoneApplicationPage
    {
        public LoginSendAlertPage()
        {
            InitializeComponent();
            btnSendAlert1.Foreground = new SolidColorBrush(Color.FromArgb(255, 0, 0, 255));
            txtName.Text = ConfigClass.UserData.user.FullName;
            txtPhone.Text = ConfigClass.UserData.user.Phone;
...
{
    new KeyValuePair<string, string>("data.USERID", ConfigClass.UserData.user.UserID.ToString()), 
