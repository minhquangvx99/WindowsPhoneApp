...
{
    public partial class AutomaticHydrologyDataMiningPage : PhoneApplicationPage
    {
        public AutomaticHydrologyDataMiningPage()
        {
            InitializeComponent();
            avatarSmall.Source = new BitmapImage(new Uri(ConfigClass.UserData.user.Avatar));
            LoadStationAutomaticHydrologyDataMining("", "", "");
        }

        private async void LoadStationAutomaticHydrologyDataMining(string stationName, string sizeNo, string provinceNo)
        {
            var post = new
            {
                ...
                PROJECT_ID = ConfigClass.automaticHydrology,
                PAGEINDEX = 1,
                PAGESIZE = 100
            };
        ...
        private void Search()
        {
            ...
            LoadStationAutomaticHydrologyDataMining(txtStationName.Text, siteNo, provinceNo);
        }
        ...
        private void btnDetailStationAutomaticHydrologyDataMining_Click(object sender, RoutedEventArgs e)
        {
            var tag = (sender as Button).Tag;
            NavigationService.Navigate(new Uri("/AutomaticHydrologyDataMiningDetailPage.xaml?ST_ID=" + tag, UriKind.Relative));
        }
