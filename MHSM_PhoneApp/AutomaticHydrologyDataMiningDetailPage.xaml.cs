...
{
    public partial class AutomaticHydrologyDataMiningDetailPage : PhoneApplicationPage
    {
        string ST_ID = string.Empty;
        public AutomaticHydrologyDataMiningDetailPage()
        {
            InitializeComponent();
        ...
        private async void LoadStationAutomaticHydrologyDataMiningDetail(string ST_ID, long fromDate, long toDate)
        {
            var post = new
            {
            ...
            {
                txtTitle3.Text = "Thuỷ văn tự động";
            }
            else
            {
        ...
        private void Search()
        {
            ...
            LoadStationAutomaticHydrologyDataMiningDetail(ST_ID, from, to);
        }
