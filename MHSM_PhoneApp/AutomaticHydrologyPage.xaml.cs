...
{
    public partial class AutomaticHydrologyPage : PhoneApplicationPage
    {
        public AutomaticHydrologyPage()
        {
            InitializeComponent();
            avatarSmall.Source = new BitmapImage(new Uri(ConfigClass.UserData.user.Avatar));
            LoadStationAutomaticHydrology("","","");
        }

        private async void LoadStationAutomaticHydrology(string stationName, string sizeNo, string provinceNo)
        {
            var post = new
            {
        ...
        private void Search()
        {
            ...
            LoadStationAutomaticHydrology(txtStationName.Text, siteNo, provinceNo);
        }
        ...
        private void btnDetailStationAutomaticHydrology_Click(object sender, RoutedEventArgs e)
        {
            var tag = (sender as Button).Tag;
            NavigationService.Navigate(new Uri("/AutomaticHydrologyDetailPage.xaml?StationName=" + tag, UriKind.Relative));
        }
