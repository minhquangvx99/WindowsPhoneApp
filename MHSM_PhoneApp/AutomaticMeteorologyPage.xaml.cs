...
{
    public partial class AutomaticMeteorologyPage : PhoneApplicationPage
    {
        public AutomaticMeteorologyPage()
        {
            InitializeComponent();
            avatarSmall.Source = new BitmapImage(new Uri(ConfigClass.UserData.user.Avatar));
            LoadStationAutomaticMeteorology("","","");
        }

        private async void LoadStationAutomaticMeteorology(string stationName, string sizeNo, string provinceNo)
        {
            var post = new
            {
        ...
        private void Search()
        {
            ...
            LoadStationAutomaticMeteorology(txtStationName.Text, siteNo, provinceNo);
        }
        ...
        private void btnDetailStationAutomaticMeteorology_Click(object sender, RoutedEventArgs e)
        {
            var tag = (sender as Button).Tag;
            NavigationService.Navigate(new Uri("/AutomaticMeteorologyDetailPage.xaml?StationName=" + tag, UriKind.Relative));
        }
