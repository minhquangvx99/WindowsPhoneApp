...
{
    public partial class AutomaticHydrologyDetailPage : PhoneApplicationPage
    {
        public AutomaticHydrologyDetailPage()
        {
            InitializeComponent();
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                LoadStationAutomaticHydrologyDetail(StationName);
            }
        }

        private async void LoadStationAutomaticHydrologyDetail(string StationName)
        {
            var post = new
            {
