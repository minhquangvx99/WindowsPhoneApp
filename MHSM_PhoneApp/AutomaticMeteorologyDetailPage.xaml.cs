...
{
    public partial class AutomaticMeteorologyDetailPage : PhoneApplicationPage
    {
        public AutomaticMeteorologyDetailPage()
        {
            InitializeComponent();
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                LoadStationAutomaticMeteorologyDetail(StationName);
            }
        }

        private async void LoadStationAutomaticMeteorologyDetail(string StationName)
        {
            var post = new
            {
